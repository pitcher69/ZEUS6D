...
# === Paths
rgb_dir = "/content/data/rgb"
depth_dir = "/content/data/depth"
mask_dir = "/content/data/mask"
scene_camera_path = "/content/data/scene_camera.json"

pointcloud_output_dir = "/content/output/point_cloud"
pca_output_dir = "/content/output/dino_feature_pca"
